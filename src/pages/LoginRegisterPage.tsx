...
const REDIRECT_URL = process.env.NODE_ENV  === 'production' ? 'https://multy-formhttps://multy-form-registration-page-odkf69bql-ptrofimov7.vercel.app/' : 'http://localhost:3000/registration'
