...
const REDIRECT_URL = process.env.NODE_ENV  === 'production' ? 'https://multy-form-registration-page-c38pbbobg-ptrofimov7.vercel.app/registration' : 'http://localhost:3000/registration'
